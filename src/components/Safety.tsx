...
export default function Safety() {
  return (
    <section id="safety" className="relative overflow-hidden bg-graphite-deep py-16 sm:py-20">
      <div className="pointer-events-none absolute inset-0 bg-tread opacity-40" />
          ...
          {safetyRules.map((rule, i) => {
            ...
            return (
              <FadeIn
                key={rule.title}
                delay={i * 0.08}
                className="group flex gap-4 rounded-2xl border border-white/10 bg-graphite p-5 transition-all duration-300 hover:-translate-y-1 hover:border-blue/30 sm:p-6"
              >
