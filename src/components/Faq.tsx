...
export default function Faq({
  ...
  return (
    <section id={id} className="bg-graphite-deep py-16 sm:py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="FAQ" title={title} center />

        <FadeIn delay={0.1} className="mt-8 divide-y divide-white/10 rounded-2xl border border-white/10 bg-surface sm:mt-10">
          {items.map((item, i) => {
